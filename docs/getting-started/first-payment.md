...
* **Step 1**. Go to ['Transactions' → 'Payment invoices']({{custom.dashboard_base_url}}transactions/payment-invoices).
...
* **Step 1**: Go to ['Transactions' – 'Payout invoices']({{custom.dashboard_base_url}}transactions/payout-invoices).
