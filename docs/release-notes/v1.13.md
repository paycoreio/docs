...
We launched a full-text search, and now we are updating the database so that all newer and older transaction data will be presently available for search.
