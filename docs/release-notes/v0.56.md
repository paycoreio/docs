...
Hello all, we have released a new version (**`v0.56`**) of [PayCore.io](http://paycore.io/). 
...
These new Ledger transaction types are required to take into account the financial transactions made outside  [PayCore.io](http://paycore.io/) and can be initiated manually at the moment.
...
We’ve started refreshing  [PayCore.io](http://paycore.io/)’s UI some time ago, and PayCore.io v0.56 brings another wave of changes in this area. 
